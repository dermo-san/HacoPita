...
data_sample = PandasParameterType(pd.DataFrame({"total_line_count": pd.Series([0], dtype="int8"), "bonsai": pd.Series([0], dtype="int8"), "others": pd.Series([0], dtype="int8"), "plastic_pots_trays": pd.Series([0], dtype="int8"), "single_flower_vase": pd.Series([0], dtype="int8"), "decorative_sand": pd.Series([0], dtype="int8"), "saucers_mats": pd.Series([0], dtype="int8"), "books": pd.Series([0], dtype="int8"), "water_basins": pd.Series([0], dtype="int8"), "bonsai_seeds": pd.Series([0], dtype="int8"), "bonsai_class_items": pd.Series([0], dtype="int8"), "bonsai_soil": pd.Series([0], dtype="int8"), "bonsai_tools": pd.Series([0], dtype="int8"), "bonsai_pots": pd.Series([0], dtype="int8"), "bonsai_decor": pd.Series([0], dtype="int8"), "lucky_bag": pd.Series([0], dtype="int8"), "moss": pd.Series([0], dtype="int8"), "moss_bonsai": pd.Series([0], dtype="int8"), "chemicals_fertilizers": pd.Series([0], dtype="int8"), "wire": pd.Series([0], dtype="int8"), "decorative_stones": pd.Series([0], dtype="int8")}))
